...
def get_emotion(data, sadness_list = [], joy_list = [], fear_list = [], disgust_list = [], anger_list = []):
    ...
    API_KEY = "6EjLFuh21saupPE2yxwCxXkTL3Kxh_TlzCgNMkb8lQZb"
    URL = "https://api.kr-seo.natural-language-understanding.watson.cloud.ibm.com/instances/bcb16dc6-5939-4300-b089-61944e7892c5"
